...
const UserTasks = ({ setUpdateFun,setUpdateTask, DOMUpdate, setDOMUpdate ,UpdateStatus,setUpdateStatus,inputPurpose,setInputPurpose}) => {
    ...
    const displayDataFun=()=>{
             if(filterData.length>=0 && filterValue!==""){
                     return <FilterTask filterData={filterData} taskBoxStatusFun={taskBoxStatusFun} deleteStatus={deleteStatus} DeleteTask={DeleteTask} UpdateStatus={UpdateStatus} UpdateSymbolClick={UpdateSymbolClick} filterValue={filterValue} setInputPurpose={setInputPurpose} UserTasks={UserTasks}/>
             }else if(filterData.length==0 && filterValue==""){
                        return <InitialUserTasks UserTasks={UserTasks} taskBoxStatusFun={taskBoxStatusFun} deleteStatus={deleteStatus} DeleteTask={DeleteTask} UpdateStatus={UpdateStatus} UpdateSymbolClick={UpdateSymbolClick} setInputPurpose={setInputPurpose}/>
             }
    }
        ...
        <div className="container GetTask-OUter-Container" style={{ color: "black", marginTop: "130px" }}>
            <div className="row justify-content-center">
                <div className="col-md-6">
                    <div style={{marginTop:"-25px" ,display:"flex",justifyContent:"space-between"}}><select onChange={(e)=>{filterFun(e.target.value);setFilterValue(e.target.value)}}>
...
const UserActivity = () => {
    ...
    const inputHandlerFun=()=>{
                if(UpdateFun == null && inputPurpose=="AddTask"){
                   ...
                   return  <input type="text" class="form-control"  placeholder="Search Any Task"/>
                }else{
    ...
    return (<>
        ...
        <div className="row">
                ...
                <UserTasks setUpdateFun={setUpdateFun} DOMUpdate={DOMUpdate} setDOMUpdate={setDOMUpdate} setUpdateTask={setUpdateTask} UpdateStatus={UpdateStatus} setUpdateStatus={setUpdateStatus} inputPurpose={inputPurpose} setInputPurpose={setInputPurpose} />
